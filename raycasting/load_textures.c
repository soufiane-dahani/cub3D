...
void load_textures(t_game *game)
{
	...
	load_single_texture(game->mlx, &game->door_open_texture, game->door_open, "Failed to load door_open texture\n");
	load_single_texture(game->mlx, &game->key_texture, game->key, "Failed to load key texture\n");
}
